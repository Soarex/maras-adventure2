...
public class CameraController : MonoBehaviour
{
	...
	float focusCentering = 0.50f;

	[SerializeField, Range(1f, 360f)]
	float manualRotationSpeed = 90f, automaticRotationSpeed = 280f;

	[SerializeField, Range(-89f, 89f)]
	float minVerticalAngle = 0f, maxVerticalAngle = 60f;
	...
	bool ManualRotation()
	{
		...
		{
			orbitAngles += manualRotationSpeed * Time.unscaledDeltaTime * input;
